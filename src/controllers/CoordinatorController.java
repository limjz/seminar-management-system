...
public class CoordinatorController {
  ...
  public static boolean createSession(String sessionName, String sessionDate, String sessionTime, String sessionVenue) {
    ...
    Session newSession = new Session(sessionID, sessionName, sessionDate, sessionTime, sessionVenue);
